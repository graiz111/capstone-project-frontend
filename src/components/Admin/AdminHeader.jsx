...
const AdminHeader = () => {
  ...
  return (
  <>
      <div className='bg-yellow-200 flex justify-around p-2  items-center fixed top-0 left-0 w-full z-50 shadow-lg' >
            <div className="flex flex-0.5 items-center space-x-4 p-4">
                ...
                <div className='hidden md:block'>
                    <h1 className="text-3xl font-bold text-white">Foodie Buddie Admin</h1>
                </div>
            </div>
            ...
            <div className='flex items-center flex-0.8 gap-4 max-w-80 '>
                ...
                <div className="relative">
                    ...
                    {isOpen && (
                        ...
                        <ul className='p-1'>
                            <li className="p-2 mb-1 hover:bg-gray-200 cursor-pointer bg-green-300 rounded-full ">SignUp</li>
                            <li className="p-2 mb-1 hover:bg-gray-200 cursor-pointer bg-green-300 rounded-full ">Login</li>
                            <li className="p-2 mb-1 hover:bg-gray-200 cursor-pointer bg-orange-200 rounded-full " >Restaurants</li>
                            <li className="p-2 mb-1 hover:bg-gray-200 cursor-pointer bg-yellow-200 rounded-full ">Users</li>
                            <li className="p-2 mb-1 hover:bg-gray-200 cursor-pointer bg-yellow-200 rounded-full ">Delivery Partners</li>
