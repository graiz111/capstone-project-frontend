...
const DeliveryHeader = () => {
  ...
  return (
  <>
      <div className='bg-purple-300 flex justify-around p-2  items-center fixed top-0 left-0 w-full z-50 shadow-lg' >
            <div className="flex flex-0.5 items-center space-x-4 p-4 ">
                ...
                <div className='hidden md:block'>
                    <h1 className="text-4xl font-bold text-white ">Foodie Buddie Delivery</h1>
                </div>
            </div>
